                                            ...
                                            <DialogHeader>
                                              ...
                                              <DialogDescription>
                                                ...
                                                <div className="w-full h-full flex flex-col gap-4">
                                                    <p className="">
                                                        Est ce que vous êtes sur de vouloir supprimer cet enseignant?
                                                    </p>
                                            ...
                                            <DialogHeader>
                                              ...
                                              <DialogDescription>
                                                ...
                                                <div className="h-[31rem] w-full">
                                                    <ModifierEnseignant enseignant = {enseignant}/>
                                                </div>
                                            </DialogHeader>
                                          </DialogContent>
                                        </Dialog>
            ...
            <form onSubmit={ handleSubmit } className="space-y-4 w-full">
                ...
                <div className="w-full flex justify-center items-center">
                    <button
                        type="submit"
                        disabled={processing}
                        className="cursor-pointer w-48 mt-3 text-white
...
function ModifierEnseignant( { enseignant } : { enseignant : User } )
{
    const { data, setData, reset, processing, errors } = useForm({
